 ...
 * @author Trudetski
 */
public class PerformWeightCheckTest extends TestingBoilerplate{
@Test
    public void runTest() {
        ...
        try {
            ...
            Method performWeightCheck = check.getClass().getDeclaredMethod("performWeightCheck", List.class, AnchoredVector.class, Body.class);

            System.out.println(performWeightCheck);

            performWeightCheck.setAccessible(true);
            ...
            addedVectors.add(new AnchoredVector(point, new Vector(Unit.force, new Vector3bd("[0,1,0]"), new BigDecimal("5.0"))));
            addedVectors.add(new AnchoredVector(point, new Vector(Unit.force, new Vector3bd("[1,0,0]"), "bam")));

            AnchoredVector targetVector = new AnchoredVector(point, new Vector(Unit.force, new Vector3bd("[0,1,0]"), new BigDecimal("5.0")));

            System.out.println("PerformWeightCheck invoking....");
            Object result = performWeightCheck.invoke(check, addedVectors, targetVector, body);
            ...
            System.out.println("PerformWeightCheck invoking....");
            result = performWeightCheck.invoke(check, addedVectors, targetVector, body);
