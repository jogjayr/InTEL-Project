...
public class CheckConnectorTest extends TestingBoilerplate {
    ...
    public void pinTest() {
        ...
        try {
            ...
            // test should pass false: missing a force
            point = (Point) objectMap.get("B");
            pin2d = new Pin2d(point);
            pin2d.setName("foo");
            pin2d.attachToWorld(body);
            ...
            System.out.println("CheckConnector invoking....");
            result = checkConnector.invoke(check, candidateVectors, pin2d, body);
            resultEnum = (Enum) result;
            assertEquals("missingSomething", resultEnum.name());
            System.out.println(result);

            // test should pass false: has an extra force
            point = (Point) objectMap.get("B");
            pin2d = new Pin2d(point);
            pin2d.setName("foo");
            pin2d.attachToWorld(body);
            ...
            result = checkConnector.invoke(check, candidateVectors, pin2d, body);
            resultEnum = (Enum) result;
            assertEquals("somethingExtra", resultEnum.name());
            System.out.println(result);

            // test should pass false: has an extra moment
            point = (Point) objectMap.get("B");
            pin2d = new Pin2d(point);
            pin2d.setName("foo");
            pin2d.attachToWorld(body);
            ...
            candidateVectors.add(new AnchoredVector(point, new Vector(Unit.force, new Vector3bd("[0,1,0]"), new BigDecimal(5))));
            candidateVectors.add(new AnchoredVector(point, new Vector(Unit.force, new Vector3bd("[1,0,0]"), new BigDecimal(5))));
            candidateVectors.add(new AnchoredVector(point, new Vector(Unit.moment, new Vector3bd("[0,0,1]"), new BigDecimal(5))));
    ...
    public void rollerTest() {
        ...
        try {
            ...
            System.out.println("CheckConnector invoking....");
            Object result = checkConnector.invoke(check, candidateVectors, roller2d, body);
            Enum resultEnum = (Enum) result;
            assertEquals("passed", resultEnum.name());
            System.out.println(result);
            ...
            // test should pass false: extra force
            point = (Point) objectMap.get("A");
            roller2d = new Roller2d(point);
            roller2d.setDirection(Vector3bd.UNIT_Y);
            roller2d.setName("foo2");
            ...
            // test should pass false: extra moment
            point = (Point) objectMap.get("A");
            roller2d = new Roller2d(point);
            roller2d.setDirection(Vector3bd.UNIT_Y);
            roller2d.setName("foo2");
    ...
    public void fixTest() {
        ...
        try {
            ...
            System.out.println("CheckConnector invoking....");
            result = checkConnector.invoke(check, candidateVectors, fix2d, body);
            resultEnum = (Enum) result;
            assertEquals("somethingExtra", resultEnum.name());
            System.out.println(result);
            ...
            candidateVectors.add(new AnchoredVector(point, new Vector(Unit.force, new Vector3bd("[1,0,0]"), "zomg")));
            candidateVectors.add(new AnchoredVector(point, new Vector(Unit.force, new Vector3bd("[0,-1,0]"), "zoomj")));
            candidateVectors.add(new AnchoredVector(point, new Vector(Unit.moment, new Vector3bd("[0,0,1]"), "zoomj")));
            candidateVectors.add(new AnchoredVector(point, new Vector(Unit.moment, new Vector3bd("[0,0,1]"), "zebra")));
            ...
            // test should pass false: missing force
            point = (Point) objectMap.get("A");
            fix2d = new Fix2d(point);
            fix2d.setName("foo3");
            fix2d.attachToWorld(body);
            ...
            // test should pass false: missing a moment
            point = (Point) objectMap.get("A");
            fix2d = new Fix2d(point);
            fix2d.setName("foo3");
            fix2d.attachToWorld(body);
