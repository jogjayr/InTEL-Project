 ...
 */
public class CheckAddedLoadsTest extends TestingBoilerplate {
    ...
    public void runTest() {
        ...
        try {
            ...
            Method checkAddedLoads = check.getClass().getDeclaredMethod("checkAddedLoads");

            System.out.println(checkAddedLoads);

            checkAddedLoads.setAccessible(true);

            System.out.println("CheckAddedLoads invoking....");
            Object result = checkAddedLoads.invoke(check);
            assertNull((ArrayList) result);
            System.out.println(result);


            // test passes true, loads added and are the same
            ...
            System.out.println("CheckAddedLoads invoking....");
            result = checkAddedLoads.invoke(check);
            assertTrue((ArrayList) result != null);
            System.out.println(result);
