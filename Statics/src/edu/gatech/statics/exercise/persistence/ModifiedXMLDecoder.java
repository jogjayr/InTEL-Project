 ...
 * @author Philip Milne
 */
public class ModifiedXMLDecoder { 
    private InputStream in; 
    private Object owner; 
    private ExceptionListener exceptionListener; 
    private ModifiedObjectHandler handler; 
     ...
     */ 
    public ModifiedXMLDecoder(InputStream in) { 
        this(in, null); 
    } 
     ...
     *
     */ 
    public ModifiedXMLDecoder(InputStream in, Object owner) { 
        this(in, owner, null); 
    } 
     ...
     */ 
    public ModifiedXMLDecoder(InputStream in, Object owner, ExceptionListener exceptionListener) { 
     ...
     */
    private ModifiedObjectHandler getHandler() {
        if ( handler == null ) {
