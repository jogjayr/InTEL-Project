 ...
 * @author Philip Milne
 */
class ModifiedObjectHandler extends HandlerBase {
    ...
    public ModifiedObjectHandler(ModifiedXMLDecoder is) {
        this();
        this.is = is;
    }

    /* loader can be null */
    public ModifiedObjectHandler(ModifiedXMLDecoder is, ClassLoader loader) {
        this(is);
        this.ldr = loader;
    }
