...
// Constructors.
  ...
  // beans
        ...
        registerConstructor("edu.gatech.newbeans.Statement", new String[]{"target", "methodName", "arguments"});
        registerConstructor("edu.gatech.newbeans.Expression", new String[]{"target", "methodName", "arguments"});
        registerConstructor("edu.gatech.newbeans.EventHandler", new String[]{"target", "action", "eventPropertyName", "listenerMethodName"});
	...
	if (getBeanAttribute(type, "transient_init") == null) {
        ...
        if (pd == null) {
            ...
            try {
                ...
                Class c = Class.forName("edu.gatech.newbeans." + name.replace('.', '_')
